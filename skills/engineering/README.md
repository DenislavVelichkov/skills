...
- **[implement](./implement/SKILL.md)** — Build one approved ticket or one small plan retained in the current conversation, driving `/tdd` at pre-agreed seams and closing out with `/code-review` before committing.
